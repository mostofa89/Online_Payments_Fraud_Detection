...
**Original dataset shape:** 6,362,620 rows × 11 columns
...
The resulting displayed dataset contains **6,362,077 rows**.
...
The plot is titled *"ROC Curve - Hybrid Model (LR > RF > NN)"*.
...
| Hybrid MLP | 0.9997 | 0.9640 | 0.8164 | 0.8840 |
